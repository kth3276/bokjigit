...
$result1 = mysqli_query($conn, "SELECT * FROM gangwon");
?>
<!DOCTYPE HTML>
<!--
					...
					<div id="page" class="container">
						<div class="row">
							...
							<div id="content" class="8u skel-cell-important">
								<section>
									<a href="Gangwon.php?id=1" class="button">지역소개</a>
									<a href="Gangwon.php?id=2" class="button">통계자료</a>
									<a href="Gangwon.php?id=3" class="button">공약추천</a>
									<br>
									<br>
									<header class="major">
										<h2>gangwon</h2>
										<span class="byline">#동계올림픽 #동해바다 #횡성한우 #강원랜드 #춘천닭갈비</span>
										<br><br>
										<div class="image fit">
										<?php
											echo '<img src="images/allpics/1_gangwon/gangwon.jpeg">';
										?>
									</div>
									</header>
									<!-- <div class="image fit"> -->
									...
									if(empty($_GET['id'])===true || $_GET['id']=='1'){
										$sql = 'SELECT * FROM gangwon WHERE id=1';
										$result1 = mysqli_query($conn, $sql);
										$row = mysqli_fetch_assoc($result1);
										echo $row['desc1']."<br />"."<br />";
										echo '<h2>'.$row['desc2'].'</h2>'."<br />";
										echo $row['desc3']."<br />";
										echo '<img src="images/allpics/1_gangwon/gangwon0.jpeg" style="width:100%;">'."<br />";
										echo $row['desc4']."<br />"."<br />";
										echo $row['desc5']."<br />";
										echo "(그림을 클릭하면 확대)";
										echo '<div style="width:100%; height:width/2;">';
											echo '<div style="width:25%; height:100%; float:left;">';
											echo '<a href="images/allpics/1_gangwon/gangwon1.jpeg"><img src="images/allpics/1_gangwon/box1.jpeg" style="width:100%; height:100%; border:0px; display:block;" /></a>';
											echo '<a href="images/allpics/1_gangwon/gangwon2.jpeg"><img src="images/allpics/1_gangwon/box2.jpeg" style="width:100%; height:100%; border:0px; display:block; margin-top:0px;" /></a>';
											echo '</div>';
											echo '<div style="width:25%; height:100%; float:left;">';
											echo	'<a href="images/allpics/1_gangwon/gangwon3.jpeg"><img src="images/allpics/1_gangwon/box3.jpeg" style="width:100%; height:100%; border:0px; display:block;" /></a>';
											echo	'<a href="images/allpics/1_gangwon/gangwon4.jpeg"><img src="images/allpics/1_gangwon/box4.jpeg" style="width:100%; height:100%; border:0px; display:block; margin-top:0px;" /></a>';
											echo '</div>';
											echo '<div style="width:25%; height:100%; float:left;">';
											echo	'<a href="images/allpics/1_gangwon/gangwon5.jpeg"><img src="images/allpics/1_gangwon/box5.jpeg" style="width:100%; height:100%; border:0px; display:block;" /></a>';
											echo	'<a href="images/allpics/1_gangwon/gangwon6.jpeg"><img src="images/allpics/1_gangwon/box6.jpeg" style="width:100%; height:100%; border:0px; display:block; margin-top:0px;" /></a>';
											echo  '</div>';
											echo  '<div style="width:25%; height:100%; float:left;">';
											echo	'<a href="images/allpics/1_gangwon/gangwon7.jpeg"><img src="images/allpics/1_gangwon/box7.jpeg" style="width:100%; height:100%; border:0px; display:block;" /></a>';
											echo '<a href="images/allpics/1_gangwon/gangwon8.jpeg"><img src="images/allpics/1_gangwon/box8.jpeg" style="width:100%; height:100%; border:0px; display:block; margin-top:0px;" /></a>';
											echo '</div>';
										echo '</div>'."<br />";
									}
									if ($_GET['id']=='2'){
										$sql = 'SELECT * FROM gangwon WHERE id='.$_GET['id'];
										$result1 = mysqli_query($conn, $sql);
										$row = mysqli_fetch_assoc($result1);
										echo '<h2>'.$row['desc1'].'</h2>'."<br />"."<br />";
										echo $row['desc2']."<br />"."<br />";
										// echo '<div style="width400px; height:180px;">';
											echo '<img src="images/allpics/1_gangwon/gangwon9.jpeg" style="width:100%; height:600px;">'."<br />";
										// echo  '</div>';
										echo $row['desc3']."<br />"."<br />";
											echo '<img src="images/allpics/1_gangwon/gangwon10.jpeg" style="width:100%; height:600px;">'."<br />";
									}
								  if ($_GET['id'] == '3'){
										$sql = 'SELECT * FROM gangwon WHERE id='.$_GET['id'];
										$result1 = mysqli_query($conn, $sql);
										...
										echo '<h2>'.$row['desc1'].'</h2>'."<br />"."<br />";
										echo $row['desc2']."<br />"."<br />";
										echo '<img src="images/allpics/1_gangwon/gangwon11.jpeg" style="width:100%;">'."<br />";
									}
									?>
								<!-- </div> -->
