...
$result1 = mysqli_query($conn, "SELECT * FROM seoul");
?>
<!DOCTYPE HTML>
<!--
					...
					<div id="page" class="container">
						<div class="row">
							...
							<div id="content" class="8u skel-cell-important">
								<section>
									<a href="Seoul.php?id=1" class="button">지역소개</a>
									<a href="Seoul.php?id=2" class="button">통계자료</a>
									<a href="Seoul.php?id=3" class="button">공약추천</a>
									<br>
									<br>
									<header class="major">
										<h2>Seoul</h2>
										<span class="byline">#서울숲 #한강 #밤도깨비야시장 #DDP #서울로7017</span>
										<br><br>
										<div class="image fit">
											<?php
												echo '<img src="images/allpics/1_seoul/seoul.jpeg">';
											?>
									...
									if(empty($_GET['id'])===true || $_GET['id']=='1'){
										$sql = 'SELECT * FROM seoul WHERE id=1';
										$result1 = mysqli_query($conn, $sql);
										$row = mysqli_fetch_assoc($result1);
										echo $row['desc1']."<br />"."<br />";
										echo '<h2>'.$row['desc2'].'</h2>'."<br />";
										echo $row['desc3']."<br />";
										echo '<img src="images/allpics/1_seoul/seoul0.jpeg" style="width:100%;">'."<br />";
										echo $row['desc4']."<br />"."<br />";
										echo $row['desc5']."<br />";
										echo "(그림을 클릭하면 확대)";
										echo '<div style="width:100%; height:width/2;">';
											echo '<div style="width:25%; height:100%; float:left;">';
											echo '<a href="images/allpics/1_seoul/seoul1.jpeg"><img src="images/allpics/1_seoul/box1.jpeg" style="width:100%; height:100%; border:0px; display:block;" /></a>';
											echo '<a href="images/allpics/1_seoul/seoul2.jpeg"><img src="images/allpics/1_seoul/box2.jpeg" style="width:100%; height:100%; border:0px; display:block; margin-top:0px;" /></a>';
											echo '</div>';
											echo '<div style="width:25%; height:100%; float:left;">';
											echo	'<a href="images/allpics/1_seoul/seoul3.jpeg"><img src="images/allpics/1_seoul/box3.jpeg" style="width:100%; height:100%; border:0px; display:block;" /></a>';
											echo	'<a href="images/allpics/1_seoul/seoul4.jpeg"><img src="images/allpics/1_seoul/box4.jpeg" style="width:100%; height:100%; border:0px; display:block; margin-top:0px;" /></a>';
											echo '</div>';
											echo '<div style="width:25%; height:100%; float:left;">';
											echo	'<a href="images/allpics/1_seoul/seoul5.jpeg"><img src="images/allpics/1_seoul/box5.jpeg" style="width:100%; height:100%; border:0px; display:block;" /></a>';
											echo	'<a href="images/allpics/1_seoul/seoul6.jpeg"><img src="images/allpics/1_seoul/box6.jpeg" style="width:100%; height:100%; border:0px; display:block; margin-top:0px;" /></a>';
											echo  '</div>';
											echo  '<div style="width:25%; height:100%; float:left;">';
											echo	'<a href="images/allpics/1_seoul/seoul7.jpeg"><img src="images/allpics/1_seoul/box7.jpeg" style="width:100%; height:100%; border:0px; display:block;" /></a>';
											echo '<a href="images/allpics/1_seoul/seoul8.jpeg"><img src="images/allpics/1_seoul/box8.jpeg" style="width:100%; height:100%; border:0px; display:block; margin-top:0px;" /></a>';
											echo '</div>';
										echo '</div>'."<br />";
									}
									if ($_GET['id']=='2'){
										$sql = 'SELECT * FROM seoul WHERE id='.$_GET['id'];
										$result1 = mysqli_query($conn, $sql);
										$row = mysqli_fetch_assoc($result1);
										echo '<h2>'.$row['desc1'].'</h2>'."<br />"."<br />";
										echo $row['desc2']."<br />"."<br />";
										// echo '<div style="width400px; height:180px;">';
											echo '<img src="images/allpics/1_seoul/seoul9.jpeg" style="width:100%; height:600px;">'."<br />";
										// echo  '</div>';
										echo $row['desc3']."<br />"."<br />";
											echo '<img src="images/allpics/1_seoul/seoul10.jpeg" style="width:100%; height:600px;">'."<br />";
									}
								  if ($_GET['id'] == '3'){
										$sql = 'SELECT * FROM seoul WHERE id='.$_GET['id'];
										$result1 = mysqli_query($conn, $sql);
										...
										echo '<h2>'.$row['desc1'].'</h2>'."<br />"."<br />";
										echo $row['desc2']."<br />"."<br />";
										echo '<img src="images/allpics/1_seoul/seoul11.jpeg" style="width:100%;">'."<br />";
									}
									?>
								<!-- </div> -->
